      ...
      const displayOverrides: Record<string, any> = {
        ...
        'Profissional': {
          ...
          recursos: [
            ...
            { label: 'Desempenho', included: true },
            { label: 'Avaliações', included: true },
