...
-- Staff pode ver e editar TODAS as configs da sua empresa, independente do status
...
COMMENT ON POLICY "config_delivery_public_select" ON public.config_delivery IS 
  'Permite leitura pública apenas de configs com delivery_ativo = true. Restaurantes desativados não aparecem para clientes.';
