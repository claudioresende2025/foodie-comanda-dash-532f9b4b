            ...
            {(() => {
              const resourcesDisplay: Record<string, { label: string; included: boolean }[]> = {
                'Iniciante': [
                  ...
                  { label: 'Painel Entregador: Incluso', included: true },
                  { label: 'Delivery: Básico', included: true },
                  { label: 'Estatísticas Delivery: Não incluso', included: false },
                  { label: 'Desempenho: Não incluso', included: false },
                  { label: 'Avaliações: Não incluso', included: false },
                  { label: 'Marketing: Não incluso', included: false },
                  { label: 'Garçom: 1 usuário', included: true },
                  { label: 'Caixa: Fluxo de Caixa + Estoque', included: true },
                  { label: 'Equipe: Até 2 colaboradores', included: true },
                ],
                'Profissional': [
                  ...
                  { label: 'Desempenho: Incluso', included: true },
                  { label: 'Avaliações: Incluso', included: true },
                  { label: 'Marketing: Incluso', included: true },
                  { label: 'Garçom: Até 3 usuários', included: true },
                  { label: 'Caixa: Fluxo de Caixa + Estoque', included: true },
                ...
                'Enterprise': [
                  ...
                  { label: 'Garçom: Ilimitado', included: true },
                  { label: 'Caixa: Fluxo de Caixa + Estoque', included: true },
